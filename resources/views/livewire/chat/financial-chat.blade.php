<div class="flex h-[calc(100vh-8rem)] flex-col">
    ...
    <div class="flex-1 space-y-4 overflow-y-auto rounded-lg border border-gray-200 bg-white p-6">
        @if(empty($messages))
    ...
    <form wire:submit="ask" class="mt-4 flex gap-3">
        <input wire:model="question" type="text" placeholder="Ask about your finances..." class="flex-1 rounded-lg border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 sm:text-sm">
